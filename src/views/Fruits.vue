		...
		return {
			fruits: [
				...
				},
				{
					...
					img: 'guava-image.png',
					rating: '4,1',
					description: 'É uma das frutas mais ricas em nutrientes, sendo também uma das mais importantes, cultivadas e comercializadas. Adapta-se muito bem em nosso país.'
				},
				{
					id: 8274,
					name: 'Cereja',
